describe('Shots factory', function() {
  ...
  beforeEach(inject(function(_Shots_, _$httpBackend_, defaultJSON) {
    ...
    $httpBackend.when('GET', 'http://api.dribbble.com/v1/shots?access_token=137ef56c6219971a9e471892ca3ba330467298294886bf2519bc4d602c3b4a98').respond(defaultJSON.fakeData);
  }));
